      ...
      <div className="container mx-auto px-12">
        <div className="flex flex-col md:flex-row justify-between items-start md:space-x-10">
          <div className="mb-4 md:mb-0">
            <img src="/images/SQRlogo.jpg" alt="Logo" className="w-25 h-25 space-y-20" />
          </div>
          <div className="flex flex-col md:flex-row items-start space-y-30 md:space-y-0 md:space-x-8">
            ...
            <div className="flex flex-col">
              ...
              <div className="flex justify-center space-x-4 mb-4 text-justify">
                <a href="https://www.facebook.com" target="_blank" rel="noopener noreferrer" className="text-white hover:text-[#4DCCE6] transition-colors duration-200">
                  <FaFacebook size={24} />
                </a>
                <a href="https://www.twitter.com" target="_blank" rel="noopener noreferrer" className="text-white hover:text-[#4DCCE6] transition-colors duration-200">
                  <FaTwitter size={24} />
                </a>
                <a href="https://www.linkedin.com" target="_blank" rel="noopener noreferrer" className="text-white hover:text-[#4DCCE6] transition-colors duration-200">
                  <FaLinkedin size={24} />
                </a>
                <a href="https://www.instagram.com" target="_blank" rel="noopener noreferrer" className="text-white hover:text-[#4DCCE6] transition-colors duration-200">
                  <FaInstagram size={24} />
                </a>
              </div>
            </div>
